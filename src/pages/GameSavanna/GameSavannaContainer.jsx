...
import style from './GameSavannaContainer.module.scss'
...
const GameSavannaContainer = () => {
    ...
    return (
        isGameStarted
            ? <GameSavanna />
            : (<div className={style.game_savanna_container}>
                <div className={style.game_savanna_container_description}>
                    <h2>Саванна</h2>
                ...
                <button className={style.game_savanna_container_btn} onClick={() => {
